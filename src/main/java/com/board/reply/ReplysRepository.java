...
public interface ReplysRepository extends JpaRepository<Replys,Integer>{
    ...
    @Query("select r.content,r.questions.uploadnumber as uploadnumber from Replys r where r.author = :username")
    Page<Replys> findByUser(@Param("username") SignUpUser username, Pageable pageable);
}
